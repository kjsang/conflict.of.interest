...
"https://search.naver.com/search.naver?where=news&sm=tab_pge&query=%EC%9D%B4%ED%95%B4%EC%B6%A9%EB%8F%8C%EB%B0%A9%EC%A7%80&sort=2&photo=0&field=0&pd=3&ds=2011.01.01&de=2021.04.29&mynews=1&office_type=1&office_section_code=2&news_office_checked=1003&nso=so:r,p:from20110101to20210429,a:all&start=" -> url

PAGE <- seq(from=1,to=1011,by=10) # 시작값과 종료값을 지정해줄 수 있습니다.
...
NEWS_prep -> NEWS_newsis
NEWS_newsis %>% 
  write_excel_csv("newsis.csv")
